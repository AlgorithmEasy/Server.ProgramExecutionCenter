...
FROM ghcr.io/algorithmeasy/aspnet-dind:5.0 AS base
WORKDIR /app
EXPOSE 80
EXPOSE 443
...
WORKDIR /src
COPY ["Server.ProgramExecutionCenter.csproj", "."]
...
ENTRYPOINT ["dotnet", "AlgorithmEasy.Server.ProgramExecutionCenter.dll"]